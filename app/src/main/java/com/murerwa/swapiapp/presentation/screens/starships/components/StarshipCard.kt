package com.murerwa.swapiapp.presentation.screens.starships.components
...
@Composable
fun StarshipCard(
    starship: StarshipsQuery.Starship?
) {
    Card(
        elevation = 0.dp,
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = starship?.model ?: "indeterminate",
                    modifier = Modifier.fillMaxWidth(),
                    fontSize = 18.sp,
                    fontWeight = FontWeight.Bold,
                    color = MaroonPrimary
                ...
                Text(
                    text = starship?.starshipClass ?: "Unknown Class",
                    color = Color.Black,
                )
            }
        }
